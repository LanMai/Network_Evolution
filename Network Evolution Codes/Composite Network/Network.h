...
# define NoN 160 // total no. of neurons within NG
# define NoNe 80 // total excitatory neurons
# define NoNi 80 // total inhibitory neurons
# define NoPMe 15 // no. of excitatory PM neurons
# define NoPMi 1 // no. of inhibitory PM neurons
# define NoP NoNe // no. of neurons to be used for performance analysis of NG
...
# define SetPopBurstFreq 7 // 5000000 (for EvalPopNeuronBurstCC02)
