...

{
	...
	netparam.synS = 0.6; //0.016; // 0.32; // synaptic strength		
	netparam.synSinh = 0.36; //0.36; // 0.10; // inhibitory synaptic strength	
	netparam.SynFrac = 0.06; // fraction of all-to-all connectivity
	netparam.SynFracEI = 0.06; 
	netparam.SynFracIE = 0.06;
	netparam.SynFracII = 0.06; 
	...
	netparam.tonicConductance = 0.34;
	netparam.tonicConductanceI = 0.34; // for inhibitory neurons
